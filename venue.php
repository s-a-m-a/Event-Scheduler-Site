    ...
    align-items: center ;
        ...
        <header class="masthead">
            ...
            <div class="container-fluid mt-3 pt-2">
                <h4 class="text-center text-white">List of Our Courses/Events/Internships</h4>
                <hr class="divider">
                <div class="row-items">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="row align-items-center justify-content-center text-center h-100">
                            <div class="">
                                ...
                                <span class="truncate" style="font-size: inherit;"><small><?php echo ucwords($row['description']) ?></small></span>
                                    <br>
                                <span class="badge badge-secondary"><i class="fa fa-tag"></i> fee: <?php echo number_format($row['rate'],2) ?></span>
                                <br>
                                <br>
